...
class Jogarbot:
    ...
    def fora_tabuleiro(i, imagens_pecas, casas_ocupadas, fora_brancas, fora_pretas, lancamento):
        ...
        #funcao para na tela de inserir nome so ter 1 jogador e desenvolvimento do jogo
    ...
    #---------------------EXECUTA-JOGO-----------------------
        ...
        #---------------------BLIT---------------------
            ...
            texto_turno = fonte_texto.render(f"Turno de \"{jogadores[jogador_atual][0]}\"", True, cor_texto2)
        ...
        #---------------------PAUSA---------------------
            if pausado:
                ...
                tela_pausa = fonte_texto.render('Jogo Pausado', True, cor_texto_tela_pausa)
